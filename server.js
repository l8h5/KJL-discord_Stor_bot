/**
 * ╔══════════════════════════════════════════════════════════════╗
 * ║           نظام الترخيص المركزي - server.js                  ║
 * ║   خادم HTTP (للعملاء) + بوت Discord (للإدارة) في ملف واحد  ║
 * ║   النشر: Render.com ← GitHub                                ║
 * ╚══════════════════════════════════════════════════════════════╝
 *
 * متغيرات البيئة المطلوبة في Render:
 *   BOT_TOKEN       = توكن بوت Discord الخاص بك
 *   ADMIN_GUILD_ID  = ID سيرفر Discord الذي تدير منه
 *   ADMIN_ROLE_ID   = ID الرول المسموح له بإنشاء الرخص
 *   SECRET_SALT     = كلمة سر عشوائية طويلة لتوليد الـ HMAC
 *   PORT            = (اختياري - Render يضعه تلقائياً)
 */
